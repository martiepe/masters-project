...
\begin{figure}[H]% 
    \centering
    \subfloat[\centering Perlin noise covariate simulation]{{\includegraphics[width=.45\linewidth]{Images/ch3/covariate 1 plot.pdf} }}%
    \qquad
    \subfloat[\centering Perlin noise covariate simulation]{{\includegraphics[width=.45\linewidth]{Images/ch3/covariate 2 plot.pdf} }}%
    \qquad
    \subfloat[\centering Utilization distribution]{{\includegraphics[width=.45\linewidth]{Images/ch3/UD plot.pdf} }}%    
