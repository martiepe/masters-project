...
params = matrix(NA, ncol = 5, nrow = 5*24)
for (ik in 1:24) {
  beta <- c(4,2,-0.1)
  thin = 100
  dt = 0.01
  ...
  for (jk in 1:5) {
    ...
    #constructing Brownian  bridge covariance matrix
    ...
    #likelihood function using paralellization 
  ...
  save(df,file="varying_M_estimates_stochastic_likelihood.Rda")
